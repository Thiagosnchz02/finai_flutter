// lib/features/budgets/screens/add_edit_budget_screen.dart
...
class AddEditBudgetScreen extends StatefulWidget {
  final Budget? budget; // Para editar un presupuesto existente
...
class _AddEditBudgetScreenState extends State<AddEditBudgetScreen> {
  ...
  void initState() {
    super.initState();
    if (isEditing) {
      // Si estamos editando, solo necesitamos la categoría actual.
            ...
            child: ListView(
              ...
              DropdownButtonFormField<String>(
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) return 'El límite es obligatorio';
                    if (double.tryParse(value.replaceAll(',', '.')) == null) return 'Número no válido';
                    return null;
                  },
                ),
